...
.EXAMPLE
    ...
    .\scripts\run_inference.ps1 -Port 9000 -ResultsDir D:\models\diffusion

.EXAMPLE
    # Quick smoke test — generate one image per available model and exit:
    .\scripts\run_inference.ps1 -SelfTest
#>
