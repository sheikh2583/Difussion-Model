"""
generate_checkpoints_3060.py
-----------------------------
Generates sample image grids from every saved checkpoint for
Flow Matching with Logit-Normal time sampling (FM-LN) on the 3060.

Usage (from project root, venv activated):
    python generate_checkpoints_3060.py

Output:
    results/checkpoint_samples/fm_lognorm/epoch10_nfe1.png
    results/checkpoint_samples/fm_lognorm/epoch10_nfe20.png
    ...
"""
...
RUNS = [
    {
        "label":         "fm_lognorm_rtx3060",
        "config_path":   "./results/fm_lognorm_rtx3060/config.json",
        "ckpt_dir":      "./results/fm_lognorm_rtx3060/checkpoints",
        "algorithm_cls": FlowMatchingLognormAlgorithm,
        "ckpt_prefix":   "FlowMatchingLognormAlgorithm_epoch",
    },
]
# ------------------------------------------------------------------ #
