...
**`PLAN.md`** (project root) contains the active task plan generated by Claude web.
Both agents must read it at the start of every session and use it to stay aligned.
The user pastes updated plans directly into that file.
